    ...
    <div class="nav-align-top my-4">
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item">
                <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-top-projects" aria-controls="navs-top-projects" aria-selected="true">
                    <i class="menu-icon tf-icons bx bx-briefcase-alt-2"></i>Projects
                </button>
            </li>
            <li class="nav-item">
                <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-top-tasks" aria-controls="navs-top-tasks" aria-selected="false">
                    <i class="menu-icon tf-icons bx bx-task"></i>Tasks
                </button>
            </li>
        </ul>
        <div class="tab-content">
                ...
                <div class="card shadow">
                    <div class="table-responsive text-nowrap">
                        ...
                        <div class="d-flex justify-content-between">
                            <h4 class="fw-bold mx-4 mt-4">{{$user->first_name}}'s Projects</h4>
                        </div>
            ...
            <div class="tab-pane fade" id="navs-top-tasks" role="tabpanel">
                ...
                <div class="card shadow">
                    <div class="table-responsive text-nowrap">
                        <h4 class="fw-bold mx-4 mt-4">{{$user->first_name}}'s Tasks</h4>
                        <div class="mx-2 mb-2">
