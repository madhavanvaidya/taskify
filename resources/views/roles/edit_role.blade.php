...
<div class="container mt-4">
    <div class="d-flex justify-content-between">
        <h4 class="fw-bold mb-0 text-capitalize">
            <span class="text-muted fw-light">Settings /</span> Edit {{$role->name}} Role
        </h4>
        <div>
            ...
            <form action="{{url('/roles/update/' . $role->id)}}" method="POST">
                ...
                <div class="row">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" id="name" name="name" placeholder="Enter Name" value="{{$role->name}}">
                    </div>
                </div>
                                ...
                                <td>
                                    <div class="d-flex flex-wrap justify-content-between">
                                        ...
                                        <div class="form-check mx-4">
                                            <input type="checkbox" name="permissions[]" value="<?php print_r(Permission::findByName($permission)->id); ?>" class="form-check-input" {{$role->hasPermissionTo($permission) ? 'checked' : ''}}>
